...
export { default as Checkbox } from '../../../extension-polkagate/src/components/Checkbox';
...
export { default as MnemonicSeed } from '../../../extension-polkagate/src/components/MnemonicSeed';
