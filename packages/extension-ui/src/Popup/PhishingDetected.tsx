    ...
    <>
      ...
      <Grid height='80px' m='auto' sx={{ '> div .warning-message': { display: 'block' } }} width='90%' >
        <Warning
          ...
          theme={theme}
        >
          {t('Note that this  website was reported on a community-driven, curated list. It might be incomplete or inaccurate. If you think that this website was flagged incorrectly')}, {<a href='https://github.com/polkadot-js/phishing/issues/new' rel='noreferrer' style={{ color: theme.palette.text.primary }} target='_blank'>{t('please open an issue by clicking here')}.</a>}
        </Warning>
      </Grid>
    </>
  );
