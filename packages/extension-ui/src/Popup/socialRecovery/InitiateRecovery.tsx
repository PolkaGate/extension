      ...
      {initiatedRecovery || activeProxy
        ...
        : <>
          ...
          <Typography fontSize='14px' fontWeight={400} width='100%'>
            {t('The account recovery process for a lost account must be initiated by a rescuer through a token deposit.')}
          </Typography>
          <Typography fontSize='22px' fontWeight={700} pt='10px' width='100%'>
            {t('Step 1 of 2: Confirm lost account ')}
          </Typography>
          <SelectTrustedFriend
            ...
            chain={chain}
            disabled={false}
            helperText={t('Find the account you want to rescue by entering their address or any associated identity details, such as their name, email, Twitter, etc.')}
            iconType='none'
