    ...
    <Grid container item sx={{ display: 'block', px: '10%' }}>
      ...
      <Grid container item sx={{ '> div.belowInput': { m: 0 }, '> div.belowInput .warningImage': { fontSize: '25px' }, height: '55px', pt: '15px' }}>
        <Warning
          ...
          theme={theme}
        >
          {t('If you\'ve lost access to this account, start the recovery process with a new account and contact the trusted friends for account recovery.')}
        </Warning>
      </Grid>
      <Grid container item justifyContent='space-between' pt='35px'>
        ...
        <Grid container item sx={{ '> div': { m: 0, width: '100%' } }} xs={8}>
          <TwoButtons
            ...
            secondaryBtnText={t('Unrecoverable account')}
          />
        </Grid>
      </Grid>
    </Grid>
