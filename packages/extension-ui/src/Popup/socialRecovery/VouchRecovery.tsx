  ...
  return (
    <Grid container item sx={{ display: 'block', px: '10%' }}>
      ...
      <Typography fontSize='14px' fontWeight={400} width='100%'>
        {t('Enter both the lost account and the rescuer account, which initiated the recovery process for the lost account. This will allow you to proceed with vouching for them.')}
      </Typography>
      <Typography fontSize='22px' fontWeight={700} pt='10px' width='100%'>
        {t('Step 1 of 2: Verify accounts')}
      </Typography>
      <SelectTrustedFriend
        ...
        chain={chain}
        disabled={false}
        helperText={t('Find the lost account by entering their address or any associated identity details, such as their name, email, Twitter, etc.')}
        iconType='none'
        label={t('Lost accounts')}
        onSelectFriend={selectLostAccount}
        placeHolder={t('Enter account ID or address')}
      ...
      <SelectTrustedFriend
        ...
        chain={chain}
        disabled={false}
        helperText={t('Find the rescuer account by entering their address or any associated identity details, such as their name, email, Twitter, etc.')}
        iconType='none'
        label={t('Rescuer accounts')}
