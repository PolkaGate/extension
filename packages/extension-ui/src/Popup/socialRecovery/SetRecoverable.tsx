      ...
      <Grid alignContent='center' alignItems='center' container item>
        ...
        <Grid item>
          <Typography fontSize='30px' fontWeight={700} py='20px' width='100%'>
            {mode === 'ModifyRecovery'
              ? t('Modify your account recoverability')
              : t('Make your account recoverable')
            }
          </Typography>
        </Grid>
      </Grid>
      ...
      {configStep === CONFIG_STEPS.SELECT_TRUSTED_FRIENDS &&
        <>
          <Typography fontSize='14px' fontWeight={400} width='100%'>
            {t('Add trusted friends\' accounts to the list, either by manually entering their information or by selecting from those available in your extension. (Recommended: 3, maximum: 9)')}
          </Typography>
          <Grid container item justifyContent='space-between' py='15px'>
            <SelectTrustedFriend
              ...
              chain={chain}
              disabled={false}
              helperText={t('Find your trusted friend\'s account by entering their address or any associated identity details, such as their name, email, Twitter, etc.')}
              label={t('Find trusted friends accounts')}
