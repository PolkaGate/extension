  ...
  return (
    <>
      ...
      <Typography sx={{ fontSize: '14px', fontWeight: 400, textAlign: 'center', px: '15px' }}>
        {t('Before we begin, here are a few important points to keep in mind:')}
      </Typography>
      <Box sx={{ backgroundColor: 'background.paper', border: '0.5px solid', borderColor: 'secondary.light', borderRadius: '5px', fontSize: '14px', m: '24px 15px 17px', p: '0' }}>
        <List sx={{ color: 'text.primary' }}>
          <ListItem sx={{ py: '2px' }}>
            ...
            <ListItemText
              primary={t('We do not send any clicks, pageviews, or events to a central server.')}
          ...
          <ListItem sx={{ py: '2px' }}>
            ...
            <ListItemText
              primary={t('We do not utilize any trackers or analytics.')}
              primaryTypographyProps={{ fontSize: '14px' }}
            />
          </ListItem>
          <ListItem sx={{ py: '2px' }}>
            ...
            <ListItemText
              primary={t('We do not collect keys, addresses, or any personal information. Your data always stays on this device.')}
              primaryTypographyProps={{ fontSize: '14px' }}
            />
          </ListItem>
          <ListItem sx={{ py: '2px' }}>
            ...
            <ListItemText
              primary={t('We are committed to respecting your privacy and are not engaged in information collection – not even anonymized data.')}
              primaryTypographyProps={{ fontSize: '14px' }}
            />
          </ListItem>
        </List>
      ...
      <Typography component={'p'} sx={{ fontSize: '14px', fontWeight: 400, pl: '25px' }}>
        {t('Thank you for choosing Polkagate!')}
      </Typography>
      <PButton
        _onClick={_onClick}
        _variant={'contained'}
        text={t('Got it, Take Me In')}
      />
    </>
  );
};
