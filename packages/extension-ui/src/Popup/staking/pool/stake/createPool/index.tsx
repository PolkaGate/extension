  ...
  return (
    <>
      <HeaderBrand
        ...
        text={t('Pool Staking')}
      />
      <SubTitle label={t('Create Pool')} withSteps={{ current: 1, total: 2 }} />
      <Grid container m='20px auto 10px' width='92%'>
        <InputWithLabel label={t('Pool name')} onChange={_onPoolNameChange} placeholder={DEFAULT_POOLNAME} value={poolName} />
      </Grid>
      <AmountWithOptions
      ...
      <PButton _onClick={toReview} disabled={toReviewDisabled} text={t('Next')} />
      {showRoles &&
        <UpdateRoles
          address={address}
          bouncerId={bouncerId}
