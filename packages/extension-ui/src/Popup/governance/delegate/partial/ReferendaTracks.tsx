  ...
  return (
    <>
      <Grid container justifyContent='space-between' pt='15px'>
        <Grid item>
          <Infotip2 showQuestionMark text={t('Please select the categories for which you would like to delegate your votes.')}>
                      ...
                      <>
                        {(!!trackVotes && !trackLockExpired) || filterTrack || (!!trackVotes && trackLockExpired)
                          ? <Infotip2
                            ...
                            text={
                              filterTrack
                                ? t('Already delegated to another account')
                                : trackLockExpired
                                  ? t('This category includes expired locks that can be unlocked and made available.')
                                  : t('Has already {{trackVotes}} vote(s)/lock', { replace: { trackVotes } })
                            }
                          >
