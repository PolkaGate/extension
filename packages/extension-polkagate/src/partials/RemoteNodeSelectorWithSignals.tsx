...
const ListIndicator = ({ currentDelay, defaultColor, endpointUrl, iconSize, id, onClick, setCurrentDelay }: ListIndicatorProps) => {
  ...
  return (
    <Grid aria-describedby={id} component='button' container item onClick={onClick} sx={{ bgcolor: bgcolorOnAccountDetail, border: '1px solid', borderColor: 'divider', borderRadius: '5px', cursor: 'pointer', height: `${iconSize + 7}px`, position: 'relative', width: `${iconSize + 7}px`, zIndex: 10 }}>
      {isLightClient
