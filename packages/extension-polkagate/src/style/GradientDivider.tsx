...
export default function GradientDivider({ isBlueish, orientation = 'horizontal', style }: GradientDividerProps): React.ReactElement {
  ...
  const themedDivider = isBlueish
    ? theme.palette.dividerGradient.replace('90deg', '0deg')
  ...
  const DividerStyle = {
    background: orientation === 'horizontal' || isBlueish
      ...
      : isDark
        ...
        : `linear-gradient(90deg, rgba(217, 204, 242, 0) 0%, ${theme.palette.surface.input} 50.06%, rgba(217, 204, 242, 0) 100%)`,
    border: 'none',
