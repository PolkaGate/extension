...
function CreationButton ({ Icon, label, labelPartInColor = '', url }: { Icon: Icon, label: string, labelPartInColor?: string, url: string, }): React.ReactElement {
  ...
  return (
    <Box
      ...
      sx={{ background: hovered ? '#2D1E4A' : '#2D1E4A8C', borderRadius: '18px', cursor: 'pointer', height: '148px', p: '15px 15px', position: 'relative', width: '148px' }}
    >
