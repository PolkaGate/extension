...
export default function Nominators ({ genesisHash, nominators }: Props) {
  ...
  return (
    <Stack direction='column' sx={{ width: '100%' }}>
      ...
      <Stack direction='column' ref={refContainer} sx={{ gap: '4px', maxHeight: 'calc(100vh - 613px)', maxWidth: '1050px', minHeight: '220px', overflow: 'auto', width: '100%', position: 'relative' }}>
        {!nominators &&
