...
export const lightTheme: ExtendedThemeOptions = {
  ...
  palette: {
    ...
    dividerGradientFade: 'linear-gradient(90deg, rgba(221, 227, 244, 0) 0%, #DDE3F4 50.06%, rgba(221, 227, 244, 0) 100%)',
    dividerGradientStrong: 'linear-gradient(90deg, rgba(221, 227, 244, 0.15) 0%, rgba(221, 227, 244, 1) 50.06%, rgba(221, 227, 244, 0.15) 100%)',
    gradient: {
