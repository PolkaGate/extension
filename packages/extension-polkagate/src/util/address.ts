...
export function getFormattedAddress (_address: string | null | undefined, _chain: Chain | null | undefined, settingsPrefix: number): string | undefined {
    if (isEthereumAddress(String(_address))) {
      return;
    }
