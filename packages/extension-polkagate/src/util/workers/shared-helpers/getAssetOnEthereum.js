...
import { FETCHING_ASSETS_FN, NATIVE_TOKEN_ASSET_ID, TEST_NETS } from '../../constants';
import { ERC20_ABI, ERC20_TOKENS, ETH_GENESISHASH_MAP } from '../../evmUtils/constantsEth';
...
export const getEthBalances = async (/** @type {string} */ chainName, /** @type {string[]} */ addresses) => {
  ...
  try {
    ...
    genesisHash = ETH_GENESISHASH_MAP[chainName.toLowerCase()];
  }
 ...
 */
export async function getAssetOnEthereum(addresses, chainName, port) {
  const results = {};
