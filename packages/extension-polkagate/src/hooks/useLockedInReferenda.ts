...
interface OutputType {
  ...
  hasDescription: string | true | null | undefined;
  isDisable: boolean;
...
export default function useLockedInReferenda (address: string | undefined, refreshNeeded: boolean | undefined): OutputType {
  ...
  const { lockedInRef, timeToUnlock, totalLocked, unlockableAmount } = useTimeToUnlock(address, referendaLocks, refreshNeeded);
