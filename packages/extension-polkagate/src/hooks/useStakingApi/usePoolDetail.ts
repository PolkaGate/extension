...
import { calcPrice, isHexToBn } from '../../util';
...
export const usePoolDetail = (
  ...
  const [collapse, dispatchCollapse] = useReducer(collapseReducer, { Ids: false, Members: false, Nominations: false, Rewards: false, Roles: false });
