...
export default function useBalancesOnMultiAssetChain2 (address: string | undefined, genesisHash: string | undefined, assetId?: string | number): BalancesInfo | undefined {
