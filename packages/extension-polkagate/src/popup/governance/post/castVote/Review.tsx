...
import { AccountContext, AccountHolderWithProxy, ActionContext, Motion, PasswordUseProxyConfirm, ShowValue, WrongPasswordAlert } from '../../../../components';
...
export default function Review({ address, estimatedFee, formatted, voteInformation }: Props): React.ReactElement<Props> {
