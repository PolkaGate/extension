...
import { AccountContext, ActionContext, ButtonWithCancel, FormatBalance, Identicon, Motion, PasswordWithUseProxy, Popup, ShortAddress, Warning } from '../../../../components';
...
export default function Review({ address, amount, api, chain, fee, formatted, maxUnlockingChunks, poolWithdrawUnbonded, setShow, show, unbonded, unlockingLen }: Props): React.ReactElement {
  ...
  const unstake = useCallback(async () => {
    try {
      ...
      setTxInfo({
        ...
        failureText,
        fee: fee || '',
        from: { address: formatted, name: name },
        status,
  ...
  }, [amount, api, chain, decimals, fee, formatted, name, password, selectedProxyAddress, selectedProxyName]);
