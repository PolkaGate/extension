...
export const news: News[] = [
  ...
  },
  {
    ...
    'bug fixes': ['Fix Known Issues: Resolve known problems, including handling foreign assets on asset hubs and addressing other minor bugs.']
  },
  {
    version: '0.32.1',
    features: ['Support Spanish: Access PolkaGate in your preferred language.'],
    'bug fixes': ['Fix known issues: correct the Czech Republic flag display and resolve the favorite chain dialog issue.']
  },
  {
    version: '0.31.1',
    features: [
  ...
  {
    version: '0.21.6',
    features: ['Show Support Us Notification: Encourage users to support us by voting for our referenda in governance.'],
    'bug fixes': ['Known Issues Resolved: Removed locked amount button if no funds are locked, fixed underway votes type in the tooltip, corrected the referenda unlock modal close button, addressed vote type issues in comments, and improved the governance timeline display.']
  },
  {
    version: '0.21.1',
    features: [
  ...
  },
  {
    ...
    'bug fixes': ['Resolved Issues: Fixes include chain switching on staking pages, delegate vote tracking, unexpected account import closures, missing connected dApp icons, and profile menu bugs in extension mode.']
  },
  {
    version: '0.7.5',
    features: ['Alerts now keep you informed: Notifications have been added to update you on tasks running in the background.'],
    'bug fixes': ['Resolved several Ledger issues: These include fixing the missing offset in advanced mode, addressing a Kusama-related bug, and resolving a race condition when accessing the port. If you encounter issues while signing with your Ledger, please reimport your Ledger accounts.']
  },
  {
    version: '0.7.3',
    features: [
  ...
  {
    version: '0.6.4',
    features: ['Support for Ledger Polkadot Generic App: The new Generic Ledger App and Migration App are now supported.'],
    'bug fixes': [
  ...
  },
  {
    ...
    'bug fixes': ['Bug Fixes and Performance Improvements: This update enhances performance and provides a more streamlined user experience by fixing known issues.']
  }
];
