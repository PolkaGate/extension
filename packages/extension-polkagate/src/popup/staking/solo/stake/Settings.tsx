...
export default function Settings({ chain, decimal, setSettings, setShowAdvanceSettings, settings, showAdvanceSettings, stakingConsts, token }: Props): React.ReactElement<Props> {
