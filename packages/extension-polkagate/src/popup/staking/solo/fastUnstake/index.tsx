    ...
    <Motion>
      ...
      <Grid container direction='column' m='20px auto' width='85%'>
        ...
        <Grid alignItems='center' container item lineHeight='28px' pl='5px'>
          ...
          <Typography fontSize='14px' fontWeight={300} lineHeight='inherit' pl='5px'>
            {t<string>('Not being rewarded in the past {{erasToCheckPerBlock}} {{era}}', { replace: { erasToCheckPerBlock: erasToCheckPerBlock || '...', era: erasToCheckPerBlock && erasToCheckPerBlock > 1 ? 'eras' : 'era' } })}
          </Typography>
        </Grid>
      </Grid>
