...
import AccountWithProxyInConfirmation from '../../../../../../components/AccountWithProxyInConfirmation';
...
export default function JoinPoolTxDetail({ pool, txInfo }: Props): React.ReactElement {
